...
这是一个基于 Payload CMS 构建的内容管理系统，支持富文本编辑、标签、发布日期等功能。
...
1. 克隆仓库：
   ```bash
   git clone https://github.com/shinebar/payload_pro_cms.git
   cd my-payload-app
...
1.
在 src/collections/ 目录下创建新的集合文件

2.
在 src/payload.config.ts 中导入并添加到 collections 数组
